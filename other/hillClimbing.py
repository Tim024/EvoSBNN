...
Original file is located at
    https://colab.research.google.com/drive/1NKoqRpWoRXQclMMZVip7kS2TXVeK64dl
"""
...
SBNN = BNNANIL(input_size, hidden_size, output_size)
...
toolbox.register("individual", tools.initRepeat, creator.Individual,
                 toolbox.attr_bool, total_length)
...
def evalOneMax(individual):
    ...
    #print(output[0], Y_train[:batch_size][0])
    return accuracy,
...
toolbox.register("mutate", tools.mutFlipBit, indpb=100/total_length)
...
def main():
    ...
    # Begin the evolution
    while max(fits) < 1 and g < 10000000:
        # A new generation
        g = g + 1
        ...
        if offspring[0].fitness.values[0] > pop[0].fitness.values[0]:
            pop[:] = offspring
